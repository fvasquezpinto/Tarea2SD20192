...
def hablar():
	...
	while(True):
		message = "mensaje random " + str(random.randint(0,9)) + str(random.randint(1,9))
		...
		print("Escriba mensaje:",message)
		receiver = "Juan_Perez"
		print("Destinatario:",receiver)
...
def crearUsuario():
	...
	global username 
	username = "Alvaro_Gomez"
	print ("Escriba nombre de usuario:", username)
