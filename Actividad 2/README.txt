...
En caso de que salga un error de fallo de conexión puede deberse a que server.py o client1.py o client2.py inicializó antes de que RabbitQM estuviera totalmente operativa. Volver a intentarlo. Ejecutando los comandos los clientes 1 y 2 enviaràn los nombres de usuarios automaticamente y enviarán mensajes con un numero aleatorio cada 10 segundos entre ellos.
...
2. Para agregar un nuevo cliente a la arquitectura
	...
	sudo docker container run  -v /home/gabriel/Escritorio/Tarea2SD20192/Actividad\ 2/client/:/client/ --network host -i -t client_n
